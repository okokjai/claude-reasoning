...
export interface EntityCheckInput {
  ...
  has_review_platform: boolean;     // whether review platforms were checked
  unsourced_count: number;           // entities without a traceable source
  sourced_count: number;             // entities with a traceable source
  recommended_entities: string[];   // entities recommended to the user
}
